...
const AddSubTask = lazy(() => import('./AddSubTask'));
const ConfirmatioDialog = lazy(() => import('../Dialogs'));
    ...
    <>
      <div>
        <Menu as='div' className='relative inline-block text-left'>
          ...
          >
          <Menu.Items className='absolute p-4 right-0 mt-2 w-56 origin-top-right divide-y divide-gray-100 rounded-md bg-white shadow-md ring-1 ring-black/5 focus:outline-none max-h-96 overflow-auto z-50'>
